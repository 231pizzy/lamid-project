...
export default function ToDo({ teamGoals, setShowGoalDetails, setSelectedGoal }) {
    // teams state
    ...
    const toDoGoals = teamGoals.filter(goal => goal.goalStatus === "To do");


    return (
        <div>
            <Box sx={{ maxWidth: { xs: '100%', md: '380px' }, minWidth: { xs: '100%', md: '380px' }, borderRadius: '16px', mt: 3, border: '2px dashed #1C1D221A' }}>
                {/* Heading */}
                <Box sx={{
