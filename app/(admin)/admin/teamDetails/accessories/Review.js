...
export default function Review({ teamGoals, setShowGoalDetails, setSelectedGoal }) {
            ...
            <Box sx={{ maxWidth: { xs: '100%', md: '400px' }, minWidth: { xs: '100%', md: '400px' }, borderRadius: '16px', mt: 3, border: '2px dashed #1C1D221A' }}>
                ...
                <Box sx={{
                    ...
                    <Typography sx={{ fontWeight: 700, fontSize: 16, ml: 4, textTransform: 'uppercase' }}>
                        review ({teamGoals.filter(goal => goal.goalStatus === 'In review').length})
                    </Typography>
                ...
                <Box sx={{ maxHeight: '40vh', overflowY: 'auto', bgcolor: 'rgba(28, 29, 34, 0.08)', p: 2, }}>
                    ...
                    {teamGoals
                        .filter(goal => goal.goalStatus === 'In review')
                        .map((goal, index) => {
                            ...
                            return (
                                <Box key={index} style={{ backgroundColor: 'white', Padding: "10px", Cursor: "pointer", marginBottom: "10px", borderRadius: "10px" }} className="cursor-pointer" onClick={() => handleTaskClick(goal)}>
                                    {/* Goal name */}
                                    <Box>
