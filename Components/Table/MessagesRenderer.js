import { EmailSvg, FacebookCountSvg, FacebookSvg, NoteCountSvg, NoteSvg } from "@/public/icons/icons";
...
const MessagesRenderer = (props) => {
    ...
    const mapping = [
        { id: 'email', double: true, icon: <EmailSvg style={iconStyle} /> },
        { id: 'facebook', double: true, icon: <FacebookCountSvg style={iconStyle} /> },
        { id: 'notes', icon: <NoteCountSvg style={iconStyle} /> },
    ];
